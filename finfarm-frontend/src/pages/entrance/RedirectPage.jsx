  ...
  const sendCodeToBackend = async (code) => {
    ...
    try {
      ...
      if (res.data.member) { // member: True 인 경우, 로그인 처리
        ...
        useUserStore.setPointsInthePocket(res.data.memberCurPoint);
        useUserStore.setProfileImageUrlt(res.data.memberImageUrl);
        useUserStore.setNickname(res.data.memberNickname); // 진짜 닉네임
        useUserStore.setIsQuizSolved(res.data.memberSolveQuiz);
        useUserStore.setDateOfSignup(res.data.memberCreateDate);
