...
export default function MainHomePage() {
  ...
  const handleQuizAttempt = async () => {
    ...
    if (canSolveQuiz) {
      ...
      if (data && Array.isArray(data.choices) && typeof data.correct === 'string' && typeof data.question === 'string') {
    ...
    return(
        <div class="flex ">
          ...
          <div class="flex items-stretch">
            ...
            <div class="ml-20 flex flex-col justify-between items-center h-96">

              <p className='text-5xl text-center'>환영합니다, {nickname}님!</p>

              <img src={quiz} alt="quiz" className="mt-20 mb-10" width='200px'/>

              <div class="flex">
                <div class="flex flex-col items-center justify-between">
                  <p className='text-3xl text-center'>데일리 농산물 퀴즈에 도전하고</p>
                  <p className='text-3xl text-center'>5000 Point를 받아보세요!</p>
                </div>

                <button 
                className="btn btn-square h-20 w-20 bg-lime-500 font-hopang text-3xl text-white hover:bg-lime-800 ml-10"
