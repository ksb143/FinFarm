...
public class BankingAccountController {
    ...
    @ApiResponse(responseCode = "400", description = "(message : \"Insufficient Current Point\", code : 400)", content = @Content)
    @PostMapping("/deposit")
    ...
    @ApiResponse(responseCode = "400", description = "(message : \"Searched Member Not Found\", code : 400)", content = @Content)
    ...
    @ApiResponse(responseCode = "200", description = "(message : \"Success\", code : 200)",
            content = @Content(schema = @Schema(implementation = BankingAccountBalanceResponse.class)))
    @GetMapping("/balance")
